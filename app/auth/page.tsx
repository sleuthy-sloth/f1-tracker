    ...
    <div className="min-h-screen bg-f1-carbon flex items-center justify-center p-4">
      <div className="w-full max-w-md">
        ...
        <div className="mt-6 pt-6 border-t border-white/[0.07] text-center">
          <Link
            href="/archive"
            className="inline-flex items-center gap-2 text-sm text-f1-silver hover:text-f1-white transition-colors"
          >
          ...
          <p className="text-xs text-f1-silver/50 mt-2">
            No account needed — browse races, replay sessions, and view standings
          </p>
        </div>
