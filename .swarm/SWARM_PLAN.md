...
Phase: 2 [COMPLETE] | Updated: 2026-05-05T16:21:50.858Z
...
---
## Phase 4: Fix Map Overlay, Mobile Layout & Satellite [PENDING]
- [ ] 4.1: Fix TelemetryHUD: hide when no driver selected, add close button, responsive sizing [SMALL]
- [ ] 4.2: Add mobile tab bar (MAP | STANDINGS | STRATEGY) for Strategy Lab [MEDIUM]
- [ ] 4.3: Fix SatelliteTrackMap: swap to CartoDB dark tiles, fix fonts, increase timeout [MEDIUM]
